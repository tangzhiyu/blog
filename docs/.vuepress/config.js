...
module.exports = {
    ...
    themeConfig: { // 主题配置
        ...
        repo: 'tangzhiyu/blog', // 导航栏右侧生成Github链接
        ...
        author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
            name: 'Tang Zhiyu', // 必需
            link: 'https://github.com/tangzhiyu/' // 可选的
        },
            ...
            icons: [
                {
                    ...
                    title: '发邮件',
                    link: 'mailto:tangzhiyu@qq.com'
                },
                {
                    iconClass: 'icon-github',
                    title: 'GitHub',
                    link: 'https://github.com/tangzhiyu/'
                }
/*                ,
                {
                    iconClass: 'icon-erji',
        ...
        footer: { // 页脚信息
            ...
            copyrightInfo: 'Tang Zhiyu | MIT License', // 博客版权信息，支持a标签
        }
    },
    plugins: [ // 插件
